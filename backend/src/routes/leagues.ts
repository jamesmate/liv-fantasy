...
leagueRouter.get("/:id/leaderboard", async (req, res) => {
  ...
  // convention as golf leaderboards. Deliberately NO tiebreaker - two
  // teams with the exact same score are genuinely tied and should
  // share the same position, not be artificially separated by
